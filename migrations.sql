...
CREATE TABLE orders (id SERIAL PRIMARY KEY, party_id INTEGER REFERENCES parties(id), food_id INTEGER REFERENCES foods(id), total INTEGER, paid BOOLEAN DEFAULT false);
